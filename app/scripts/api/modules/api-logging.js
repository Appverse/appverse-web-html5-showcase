...
//////////////////////////////////////////////////////////////////////////////////////
    ...
    */
    ...
    .factory("formattedLogger",["LOGGING_CONFIG", function(){
        return function($delegate){
            ...
            function handleLogMessage(logLevel, callback){
                    try{
                        ...
                        var errorMessage = logLevel + "|" + LOGGING_CONFIG.CustomLogPreffix + ": " + now + "|" + arguments.toString();
