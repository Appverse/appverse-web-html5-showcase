...
angular.module('ngGrid').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('footerTemplate.html',
    ...
    "\n" +
    "                <option slyRepeat=\"size in pagingOptions.pageSizes\">{{size}}</option>\r" +
    "\n" +
    "            </select>\r" +
    "\n" +
    "        </div>\r" +
  ...
  $templateCache.put('gridTemplate.html',
    ...
    "\n" +
    "            <li class=\"ngGroupItem\" slyRepeat=\"group in configGroups\">\r" +
    "\n" +
    ...
    "\n" +
    "        <div ng-style=\"rowStyle(row)\" slyRepeat=\"row in renderedRows\" ng-click=\"row.toggleSelected($event)\" ng-class=\"row.alternatingRowClass()\" ng-row></div>\r" +
    "\n" +
    "    </div>\r" +
    "\n" +
    "</div>\r" +
  ...
  $templateCache.put('headerRowTemplate.html',
    "<div ng-style=\"{ height: col.headerRowHeight }\" slyRepeat=\"col in renderedColumns\" ng-class=\"col.colIndex()\" class=\"ngHeaderCell\">\r" +
    "\n" +
  ...
  $templateCache.put('menuTemplate.html',
    ...
    "\n" +
    "            <li class=\"ngColListItem\" slyRepeat=\"col in columns | ngColumns\">\r" +
    "\n" +
  ...
  $templateCache.put('rowTemplate.html',
    "<div ng-style=\"{ 'cursor': row.cursor }\" slyRepeat=\"col in renderedColumns\" ng-class=\"col.colIndex()\" class=\"ngCell {{col.cellClass}}\">\r" +
    "\n" +
