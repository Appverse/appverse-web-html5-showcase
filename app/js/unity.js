...
Unity={
	...
	/**
	 * Boolean to indicate if the next request send to the platform (using any Unity.<API_serviceName>.<API_serviceMethod>() call) should unscape or not the data send.
 ...
 * <br> For further information see, {@link Unity.Security.KeyPair KeyPair}.
 * <br> @version 4.2
 * @method
 * @ignore NO YET AVAILABLE (uncomment when ready)
 * @param {Unity.Security.KeyPair[]} storedKeyPairs An array of KeyPair objects successfully stored in the device local secure storage.
 * @param {Unity.Security.KeyPair[]} failedKeyPairs An array of KeyPair objects that could not be successfully stored in the device local secure storage.
 * <pre> Available in: <br> iOS <img src="resources/images/check.png"/> | android <img src="resources/images/check.png"/> | windows <img src="resources/images/error.png"/> | emulator <img src="resources/images/check.png"/></pre>
 */
Unity.OnKeyValuePairsStoreCompleted = function(storedKeyPairs, failedKeyPairs){};
 ...
 * @method
 * @ignore NO YET AVAILABLE (uncomment when ready)
 * @param {Unity.Security.KeyPair[]} foundKeyPairs An array of KeyPair objects found in the device local secure storage.
 * <pre> Available in: <br> iOS <img src="resources/images/check.png"/> | android <img src="resources/images/check.png"/> | windows <img src="resources/images/error.png"/> | emulator <img src="resources/images/check.png"/></pre>
 */
Unity.OnKeyValuePairsFound = function(foundKeyPairs){};
 ...
 * @method
 * @ignore NO YET AVAILABLE (uncomment when ready)
 * @param {Unity.Security.KeyPair[]} removedKeyPairs An array of KeyPair objects successfully removed from the device local secure storage.
 * @param {Unity.Security.KeyPair[]} failedKeyPairs An array of KeyPair objects that could not be removed from the device local secure storage.
 * <pre> Available in: <br> iOS <img src="resources/images/check.png"/> | android <img src="resources/images/check.png"/> | windows <img src="resources/images/error.png"/> | emulator <img src="resources/images/check.png"/></pre>
 */
Unity.OnKeyValuePairsRemoveCompleted = function (removedKeyPairs, failedKeyPairs){};
 ...
 * <br> For further information see, {@link Unity.System.LaunchData LaunchData}.
 * <br> URI scheme protocols could contain any relative path information before parameter query string; 
 * in this case, that information will be received as a LaunchData object with the Name equals to {@link Unity.System#LAUNCH_DATA_URI_SCHEME_PATH LAUNCH_DATA_URI_SCHEME_PATH}
 * <br> @version 4.2
 * @method
 * @param {Unity.System.LaunchData[]} launchData The launch data received.
 ...
 * 
 */
Unity.OnExternallyLaunched = function(launchData) {};
...
/**
 * URI to access Unity Local Services.
...
/**
 * URI to access Unity Local Services in Asynchronous mode.
...
/**
 * URI to access Unity Remote Resources.
...
/**
 * URI to access Unity Resources from Application Documents.
 ...
 * @type String
 */
Unity.MODULES_RESOURCE_URI = Unity.DOCUMENTS_RESOURCE_URI + 'apps/';
...
Unity.MODULES_RESOURCE_URI = 'http://127.0.0.1:' + LOCAL_SERVER_PORT + Unity.MODULES_RESOURCE_URI;
...
/**
 * Returns all applications configured to be launched (using Unity.System.LaunchApplication method) at configuration file: app/config/launch-data.xml.
 * <br> @version 4.2
 * @method
 * @return {Unity.System.App[]} Applications to be launched.
 * <pre> Available in: <br> iOS <img src="resources/images/check.png"/> *N/A | android <img src="resources/images/check.png"/> | windows <img src="resources/images/error.png"/> | emulator <img src="resources/images/check.png"/> </pre>
 */
System.prototype.GetApplications = function()
{
	return post_to_url(Unity.System.serviceName, "GetApplications", null, "POST");
};

/**
 * Returns an application configured to be launched (using Unity.System.LaunchApplication method) at configuration file: app/config/launch-data.xml, given its name.
 * <br> @version 4.2
 * @method
 * @param {String} appName The application name to match.
 * @return {Unity.System.App} Application to be launched that match the given name.
 * <pre> Available in: <br> iOS <img src="resources/images/check.png"/> *N/A | android <img src="resources/images/check.png"/> | windows <img src="resources/images/error.png"/> | emulator <img src="resources/images/check.png"/> </pre>
 */
System.prototype.GetApplication = function(appName)
{
	return post_to_url(Unity.System.serviceName, "GetApplication", get_params([appName]), "POST");
};
 ...
 * <br> @version 4.2
 * @method
 * @param {Unity.System.App/String} app The application object (or its name) to be launched.
...
{
	post_to_url(Unity.System.serviceName, "LaunchApplication", get_params([app, query]), "POST");
};
 ...
 * <br> Returned data should be handled by overriding the corresponding Platform Listeners Unity.OnRegisterForRemoteNotificationsSuccess and Unity.OnRegisterForRemoteNotificationsFailure
 * <br> @version 3.9
 * @method
 ...
 * Only {@link Unity.IO#SERVICETYPE_OCTET_BINARY SERVICETYPE_OCTET_BINARY} types are allowed in this method.
 * <br/>For further information see, {@link Unity.IO.IOService IOService} and {@link Unity.IO.IORequest IORequest}.
 * <br> @version 4.0
 * @param {Unity.IO.IORequest} requestObjt The request object with the needed invocation parameters. Example:<pre>{"Session":null,"Content":"{method:authenticationService.login,id:1,params:['username','password']}"}</pre>
 * @param {Unity.IO.IOService} service This param could be a IOService object (as provided by {@link #GetService}), or only the service name. First service match would be invoked. ATTENTION: when using the 'object', the third argument (type) shouldn't be informed.
...
{
	return post_to_url(Unity.IO.serviceName, "InvokeServiceForBinary",get_params([requestObjt,service,storePath]), "POST");
};
 ...
 * <br> Returned data should be handled by overriding the corresponding Platform Listeners Unity.OnKeyValuePairsStoreCompleted
 * <br> @version 4.2
 * @ignore NO YET AVAILABLE (uncomment when ready)
 * @method
 * @param {Unity.Security.KeyPair} keyPair A key/value pair to store
 * <pre> Available in: <br> iOS <img src="resources/images/check.png"/> | android <img src="resources/images/check.png"/> | windows <img src="resources/images/error.png"/> | emulator <img src="resources/images/check.png"/></pre>
 */
Security.prototype.StoreKeyValuePair = function(keyPair)
{
	post_to_url(Unity.Security.serviceName, "StoreKeyValuePair", get_params([keyPair]), "POST");
};
 ...
 * @ignore NO YET AVAILABLE (uncomment when ready)
 * @method
 * @param {Unity.Security.KeyPair[]} keyPair A list of key/value pairs to store
 * <pre> Available in: <br> iOS <img src="resources/images/check.png"/> | android <img src="resources/images/check.png"/> | windows <img src="resources/images/error.png"/> | emulator <img src="resources/images/check.png"/></pre>
 */
Security.prototype.StoreKeyValuePairs = function(keyPairs)
{
	post_to_url(Unity.Security.serviceName, "StoreKeyValuePairs", get_params([keyPairs]), "POST");
};

/**
 * 	Returns a previously stored key/value pair from the device local secure storage.
 * <br> Returned data should be handled by overriding the corresponding Platform Listeners Unity.OnKeyValuePairsFound
 * <br> @version 4.2
 * @ignore NO YET AVAILABLE (uncomment when ready)
 * @method
...
{
	post_to_url(Unity.Security.serviceName, "GetStoredKeyValuePair", get_params([key]), "POST");
};
...
{
	post_to_url(Unity.Security.serviceName, "GetStoredKeyValuePairs", get_params([keys]), "POST");
};

/**
 *	Removes - if already exists - a given key/value pair from the device local secure storage
 * <br> Returned data should be handled by overriding the corresponding Platform Listeners Unity.OnKeyValuePairsRemoveCompleted
 * <br> @version 4.2
 * @ignore NO YET AVAILABLE (uncomment when ready)
 * @method
...
{
	post_to_url(Unity.Security.serviceName, "RemoveStoredKeyValuePair", get_params([key]), "POST");
};
...
{
	post_to_url(Unity.Security.serviceName, "RemoveStoredKeyValuePairs", get_params([keys]), "POST");
};
 ...
 * @return {Unity.AppLoader} A new AppLoader interface.
 */
AppLoader = function() {
	/**
	 ...
	 * (after calling either the {@link Unity.AppLoader.UpdateModules UpdateModules} method or the {@link Unity.AppLoader.UpdateModule UpdateModule} method), 
	 * <br>Method to be overrided by JS applications, to handle this event.
     * <br> @version 4.0
	 * @param {Unity.AppLoader.Module[]} successUpdates The list of successful updated modules.
     * @param {Unity.AppLoader.Module[]} failedUpdates The list of failed updated modules.
	 ...
	 * (after calling the {@link Unity.AppLoader.DeleteModules DeleteModules} method), 
	 * <br>Method to be overrided by JS applications, to handle this event.
     * <br> @version 4.0
	 * @param {Unity.AppLoader.Module[]} successDeletes The list of successful deleted modules.
     * @param {Unity.AppLoader.Module[]} failedDeletes The list of failed deleted modules.
	 */
    this.onDeleteModulesFinished = function(successDeletes, failedDeletes){};
}

Unity.AppLoader = new AppLoader();


/**
 * Initializes the context of the Application Loader for the next operations.
 * <br> @version 4.0
 * @param {Unity.AppLoader.ModuleContext} context The current context options for handling modules.
 * @method
 */
AppLoader.prototype.InitializeModuleContext = function(context)
{
	post_to_url(Unity.AppLoader.serviceName, "InitializeModuleContext",  get_params([context]), "POST");
};

/**
 * Returns a list .
 * <br> @version 4.0
 * @return {Unity.AppLoader.Module[]} List of currently installed modules (locally)
 * @method
 */
AppLoader.prototype.ListInstalledModules = function()
{
	return post_to_url(Unity.AppLoader.serviceName, "ListInstalledModules",  null, "POST");
};

/**
 * Updates a given module list (or installs if it was never previously downloaded).
 * <br> @version 4.0
 * @param {Unity.AppLoader.Module[]} modules The modules to be downloaded (Unity.AppLoader.Module#LoadUrl is used for downloading each module).
...
AppLoader.prototype.UpdateModules = function(modules, callbackId)
{
	...
	post_to_url(Unity.AppLoader.serviceName, "UpdateModules",  get_params([modules,callbackId]), "POST");
};

/**
 * Updates a given module (or installs if it was never previously downloaded).
 * <br> @version 4.0
 * @param {Unity.AppLoader.Module[]} module The module to be downloaded (the field <b>Unity.AppLoader.Module#LoadUrl</b> is used for downloading each module).
 * @param {String} callbackId The callback identifier of this request to be returned on the corresponding event listener (callback). Null value is not needed.
 * @method
 */
...
{
	if(!callbackId) callbackId = "";
	post_to_url(Unity.AppLoader.serviceName, "UpdateModule",  get_params([module,callbackId]), "POST");
};

/**
 * Deletes a given modules.
 * <br> @version 4.0
 * @param {Unity.AppLoader.Module[]} modules The modules to be deleted.
 * @method
 */
AppLoader.prototype.DeleteModules = function(modules)
{
	post_to_url(Unity.AppLoader.serviceName, "DeleteModules",  get_params([modules]), "POST");
};
 ...
 * <br> @version 4.0
 * @param {Unity.AppLoader.Module} module The module to be loaded.
 * @param {Unity.AppLoader.ModuleParam[]} parameters The parameters to be added to the module main HTML file request; as GET request parameters (optional field, null for not including any parameter).
...
AppLoader.prototype.LoadModule = function(module, parameters, autoUpdate)
{
	if(autoUpdate == null || autoUpdate == false) {
		post_to_url(Unity.AppLoader.serviceName, "LoadModule",  get_params([module,parameters]), "POST");
	} else {
		post_to_url(Unity.AppLoader.serviceName, "LoadModule",  get_params([module,parameters,autoUpdate]), "POST");
	}
};
...
function post_to_url(serviceName, methodName, params, method, returnAsString) {
	...
	*/
	...
	var reqData = null;
	if(params!=null) {
		if(Unity.unescapeNextRequestData) {
			reqData = "json=" + unescape(params);
		} else {
			reqData = "json=" + params; // we don't unscape parameters if configured
			Unity.unescapeNextRequestData = true; // returning to default configuration value
		} 
	}
	try {
		xhr.send(reqData);
